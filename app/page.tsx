...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'Collect rent online, track expenses by property, and manage rentals in one simple platform built for landlords.',
    ...
    <main className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-6 lg:px-6">
        <div className="rz-fade-up mb-4 rounded-full border border-emerald-500/40 bg-gradient-to-r from-emerald-500/15 via-emerald-500/5 to-slate-900 px-4 py-2 text-center text-[11px] font-medium text-emerald-100 shadow-sm">
          🎉 Start free for{' '}
          <span className="font-semibold text-emerald-300">35 days</span>. No card required.
          Then $29.95/month.
        </div>
        ...
        <section className="grid gap-8 pb-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="rz-fade-up rz-delay-2">
            ...
            <p className="mt-4 max-w-2xl text-base text-slate-300 sm:text-lg">
              RentZentro gives landlords one simple place to collect rent, track expenses,
              manage tenants, and understand what each property is actually making.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/listings"
                className="inline-flex items-center justify-center rounded-full border border-slate-800 bg-slate-950 px-6 py-3 text-sm font-semibold text-slate-200 transition duration-200 hover:scale-[1.03] hover:border-emerald-500/60 hover:text-emerald-200 active:scale-95"
              >
                Browse rentals
              </Link>
            </div>
            ...
            <p className="mt-3 text-[12px] text-emerald-300">
              No card required • Setup in minutes • Funds go directly to your Stripe-connected account
            </p>
        ...
        <section className="rz-fade-up rz-delay-6 border-t border-slate-900 py-10">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-3xl border border-slate-800 bg-slate-950/70 p-5 transition duration-300 hover:-translate-y-1 hover:border-emerald-500/20 hover:bg-slate-900/70">
              <p className="text-sm font-semibold text-slate-50">What you can do inside RentZentro</p>
            ...
            <>
              <div className="mb-4 rounded-2xl border border-slate-800 bg-slate-950/70 p-5 transition duration-300 hover:border-emerald-500/20 hover:bg-slate-900/70">
                ...
                <p className="mt-1 text-[11px] text-slate-400">
                  Here’s what RentZentro listings look like. Real published listings will show
                  here automatically.
                </p>
              </div>
