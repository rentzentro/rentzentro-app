...
export default function DashboardPreviewUpload() {
  ...
  return (
    <div className="rz-fade-up rz-delay-3 order-2 rounded-3xl border border-[#17315f] bg-[#020b2f] p-4 shadow-[0_30px_80px_rgba(0,0,0,0.6)] ring-1 ring-white/5 sm:p-5">
      <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <label className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-cyan-300/35 bg-cyan-500/15 px-3 py-1.5 text-[11px] font-medium text-cyan-100 hover:bg-cyan-500/25">
          <input
            type="file"
      ...
      <div className="overflow-hidden rounded-2xl border border-[#20406f] bg-[#03113f]">
